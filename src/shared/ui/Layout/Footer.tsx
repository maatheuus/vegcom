...
export function Footer() {
  return (
    <footer className="padding__default relative overflow-hidden bg-gradient-to-br from-green-600 via-green-500 to-green-600 py-10 text-white">
      ...
      <div className="relative container mx-auto">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-6">
          <div className="flex flex-col gap-3">
            ...
            >
              <Logo size={32} />
              <span className="font-lora text-xl font-bold">VegCom</span>
            </Link>
            <Text
