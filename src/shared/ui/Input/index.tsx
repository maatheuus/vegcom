  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "font-maitree flex w-full rounded-xs border border-green-500 bg-transparent px-3.5 py-2 text-sm text-green-500 transition-colors placeholder:text-green-200 focus-visible:ring-1 focus-visible:ring-green-500 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 md:py-3 md:text-base",
          className,
        )}
        ref={ref}
        {...props}
